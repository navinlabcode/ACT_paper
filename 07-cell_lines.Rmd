...
```{r mb231_heatmap, cache = TRUE, fig.height=8}
...
```{r mb231ex1_heatmap, cache = TRUE, fig.height=8}
...
```{r mb231ex2_heatmap, cache = TRUE, fig.height=8}
...
```{r mb453_heatmap, cache = TRUE, fig.height=8}
...
```{r mb157_heatmap, cache = TRUE, fig.height=8}
...
```{r bt20_heatmap, cache = TRUE, fig.height=8}
