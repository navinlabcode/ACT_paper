...
Function used to generate the trees using `ape::fastme.bal()` is `make_single_cell_tree`. It is not terribly slow but, for convinience, trees generated from the following function are provided in the directory `data/trees`
...
plot_sctree(tn8_tree, title = "TN8")
```
